...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DatosDetallesDeConsulta> detallesDeConsultaJacksonTester;
    ...
    @Test
    @DisplayName("Debería Retornar Estado Http 400 Cuando Los Datos Ingresados Sean Invalidos")
    @WithMockUser
    ...
    @Test
    @DisplayName("Debería Retornar Estado Http 200 Cuando Los Datos Ingresados Sean Validos")
    @WithMockUser
    void agendarConsultaEscenario2() throws Exception {

        var fecha = LocalDateTime.now().plusHours(1);
        var especialidad = Especialidad.CARDIOLOGIA;
        var datos = new DatosDetallesDeConsulta(null, 2l, 5l, fecha);
        ...
        var jsonEsperado = detallesDeConsultaJacksonTester.write(datos).getJson();
